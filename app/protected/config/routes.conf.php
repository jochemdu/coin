...
$route['*']['/'] = array('AdController', 'index');
$route['*']['/add'] = array('AdController', 'add');
$route['*']['/add-test'] = array('AdController', 'addTest');

// $route['*']['/'] = array('AdController', 'listAds');
$route['*']['/error'] = array('ErrorController', 'index');

// $route['*']['/testdb'] = array('MainController', 'testdb');
